...
<table class="DanhSach">
	...
	<?php
		...
		{   //Các thông tin được lấy từ biến $dong và được hiển thị trong các cột tương ứng của bảng.
			echo "<tr  bgcolor='#ffffff' onmouseover='this.style.background=\"#dee3e7\"' onmouseout='this.style.background=\"#ffffff\"'>";
				...
				//Tạo liên kết để thực hiện các hành động "Hạ quyền" hoặc "Nâng quyền"
				echo "<td>";
					if($dong["QuyenHan"] == 1)
				...
				echo "</td>";
				//Tạo liên kết để thực hiện hành động "Kích hoạt" hoặc "Khóa" dựa trên giá trị của trường "Khoa" trong biến $dong.
				...
				echo "</td>";
				// Tạo liên kết để thực hiện hành động "Sửa", "Xoa" người dùng. Liên kết này chứa ID của người dùng trong tham số id.
